        ...
        <div className="relative z-10 flex items-center gap-2.5">
          <div className="w-9 h-9 flex-shrink-0">
            <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
              <defs>
                <linearGradient id="grit-g-login" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#F97316" />
                  <stop offset="100%" stopColor="#EF4444" />
                </linearGradient>
              </defs>
              <path d="M20 20 L80 20 L80 40 L40 40 L40 60 L60 60 L60 50 L80 50 L80 80 L20 80 Z" fill="url(#grit-g-login)" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        ...
        <div className="lg:hidden mb-8 flex items-center gap-2.5">
          <div className="w-8 h-8 flex-shrink-0">
            <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
              <defs>
                <linearGradient id="grit-g-m" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#F97316" />
                  <stop offset="100%" stopColor="#EF4444" />
                </linearGradient>
              </defs>
              <path d="M20 20 L80 20 L80 40 L40 40 L40 60 L60 60 L60 50 L80 50 L80 80 L20 80 Z" fill="url(#grit-g-m)" />
              <rect x="45" y="45" width="10" height="10" fill="white" opacity="0.8"/>
            </svg>
          </div>
          <span className="text-xl font-black tracking-tight" style={{ fontFamily: "var(--font-syne)", letterSpacing: "-0.02em" }}>
